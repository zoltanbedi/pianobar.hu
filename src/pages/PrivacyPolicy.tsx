    ...
    <div data-custom-class="body">
          ...
          <strong>
            <span style={{ fontSize: '15px' }}>
              <span data-custom-class="subtitle">
                Last updated <span className="question">March 27, 2022</span>
              </span>
            </span>
          </strong>
        </span>
      ...
      <div style={{ lineHeight: '1.5' }}>
        <span style={{ color: 'rgb(127, 127, 127)' }}>
          <span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
            <span data-custom-class="body_text">
              This privacy notice for <span className="question">Fűzy Gábor</span>
            ...
            <span data-custom-class="body_text">
              ,&quot; &quot;<strong>we</strong>,&quot; &quot;<strong>us</strong>,&quot; or &quot;<strong>our</strong>&quot;), describes how and why we
              might collect, store, use, and/or share (&quot;<strong>process</strong>&quot;) your information when you use our
            ...
            <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
              <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class="body_text">
                  Download and use
                  <span className="block-component">
                    <span className="block-component" /> our Facebook application
                    <span className="block-component">&nbsp;</span>(<span className="question">Fűzy Gábor)</span>
          ...
          <span style={{ fontSize: '15px' }}>
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span data-custom-class="body_text">
                ...
                <span className="question">zongoristagabibacsi@gmail.com</span>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              ...
              we may process personal information depending on how you interact with <span className="block-component" />
              <span className="question">Fűzy Gábor</span>
              <span className="statement-end-if-in-editor" /> and the Services, the choices you make, and the products
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              <strong>Do you receive any information from third parties?</strong> <span className="block-component" />
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              <strong>How do you process my information?</strong> We process your information to provide, improve, and
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              <strong>How do I exercise my rights?</strong> The easiest way to exercise your rights is by filling out
              our data subject request form available <span className="block-component" />
            </span>
          </span>
          <a
            data-custom-class="link"
            href="https://app.termly.io/notify/30fdc715-36d4-426e-9012-798fbeb64a71"
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              ...
              <span className="question">Fűzy Gábor</span>
              <span className="statement-end-if-in-editor" /> does with any information we collect? Click&nbsp;
            </span>
          </span>
          <a data-custom-class="link" href="#toc">
            <span style={{ fontSize: '15px' }}>
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}>
            <a data-custom-class="link" href="#inforetain">
              <span style={{ color: 'rgb(89, 89, 89)' }}>4. HOW LONG DO WE KEEP YOUR INFORMATION?</span>
            </a>
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span style={{ color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class="body_text">
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: '15px' }}>
            <a data-custom-class="link" href="#infominors">
              <span style={{ color: 'rgb(89, 89, 89)' }}>6. DO WE COLLECT INFORMATION FROM MINORS?</span>
            </a>
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span style={{ color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class="body_text">
            ...
            <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
              <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class="body_text">
                  ...
                  <span style={{ fontSize: '15px' }}>&nbsp;</span>(such as the date/time stamps associated with your
        ...
        <div style={{ lineHeight: '1.5' }}>
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            <div style={{ lineHeight: '1.5' }}>
              <span style={{ fontSize: '15px' }}>
                <span data-custom-class="body_text">
                  <strong>Information collected when you use our Facebook application(s).</strong> We by default access
                  your&nbsp;
                </span>
              </span>
              <a
              ...
              <span style={{ fontSize: '15px' }}>
                <span data-custom-class="body_text">
                  &nbsp;basic account information, including your name, email, gender, birthday, current city, and
                  profile picture URL, as well as other information that you choose to make public. We may also request
                  access to other permissions related to your account, such as friends, check-ins, and likes, and you
                  may choose to grant or deny us access to each individual permission. For more information regarding
                                                              ...
                                                              >
                                                                <span data-custom-class="body_text">
                                                                  ...
                                                                  <em>
                                                                    ...
                                                                    following <span className="block-component" />
                                                                    third parties.
                                                                  </em>
                                                                </span>
                                                              </span>
                                                          ...
                                                          <div style={{ lineHeight: '1.5' }}>
                                                            <span style={{ fontSize: '15px' }}>
                                                              <span data-custom-class="body_text">
                                                                ...
                                                                also <span className="statement-end-if-in-editor" /> may
                                                                ...
                                                                <div style={{ lineHeight: '1.5' }}>
                                                                  ...
                                                                  <div style={{ lineHeight: '1.5' }}>
                                                                      ...
                                                                      >
                                                                        ...
                                                                        >
                                                                          <span data-custom-class="body_text">
                                                                            ...
                                                                            <span className="block-component" /> which
                                                                    ...
                                                                    <div style={{ lineHeight: '1.5' }}>
                                                                      <span style={{ fontSize: '15px' }}>
                                                                        <span data-custom-class="body_text">
                                                                          <span className="question">Bimbó út 3</span>
                                                                          <span style={{ color: 'rgb(89, 89, 89)' }}>
                                                                            <span style={{ fontSize: '15px' }}>
                                                                              <span className="block-component" />
                                                                            </span>
                                                                    ...
                                                                    <div style={{ lineHeight: '1.5' }}>
                                                                      <span style={{ fontSize: '15px' }}>
                                                                        <span data-custom-class="body_text">
                                                                          <span className="question">Budapest</span>
                                                                          <span style={{ color: 'rgb(89, 89, 89)' }}>
                                                                            <span style={{ fontSize: '15px' }}>
                                                                              <span className="block-component" />
                                                                              <span className="block-component" />{' '}
                                                                              <span className="question">1022</span>
                                                                              <span className="statement-end-if-in-editor" />
                                                                              <span className="block-component" />
                                                                              <span className="block-component" />
                                                                            </span>
                                                                    ...
                                                                    <div style={{ lineHeight: '1.5' }}>
                                                                      <span style={{ fontSize: '15px' }}>
                                                                        <span data-custom-class="body_text">
                                                                          ...
                                                                          <span className="question">Hungary</span>
                                                                          <span style={{ fontSize: '15px' }}>
                                                                            <span data-custom-class="body_text">
                                                                              <span
                                                                                style={{ color: 'rgb(89, 89, 89)' }}
